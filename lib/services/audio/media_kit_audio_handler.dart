...
//     await _player.jump(queuePosition.trackIndex);
...
//     print('we are tryna play');
//     try {
//       await _player.open(Playlist(
//         tracks.map((item) {
//           print(item.cachePath);
//           if (item.cached &&
...
//             return Media(
//               'file://${p.join(basePath.path, item.cachePath)}',
//             );
//           }
//           return Media(
//             _repository!.getServerUrl(item.serverPath),
//           );
//         }).toList(),
